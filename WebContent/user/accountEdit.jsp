...
<body>
	<div class="sn-nav">
		...
		<div class="sn-nav-title of">填写提现账户</div>
	...
	<section class="sn-main pr">
		<div class="input-a sn-block wbox mt30 pr">
			...
			<div class="wbox-flex ml30 pr">
				<input type="text" id="account" name="account" value=""
					placeholder="请输入账户(可以是支付宝，微信，银行卡),随便填" maxlength="32">
			</div>
		...
		<a href="javascript:void(0)" id="nextStep" name="Wap_reg_person_005"
			onclick="accountEdit();return false;"
			class="first-step sn-btn sn-btn-big sn-btn-block m30 sn-btn-positive">提交</a>
	</section>
