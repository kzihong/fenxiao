											...
											<div class="wbox ">
												<div class="pro-info wbox-flex">
													<div class="pro-name of">
														<span>${oi.category.name }:</span>
														<input type="hidden" value="${oi.productTitle }" class="picbean">
													</div>
													<div class="snPrice">${oi.figure } &nbsp;&nbsp;&nbsp;
														可赢金额：
														<fmt:formatNumber value="${oi.figure*oi.odds }" type="currency" pattern=".0"/>
													</div>
													<span class="cart-number" style="float: right;">x
														${oi.quantity}</span>
												</div>
											</div>
										</a>
			...
			<div class="cart-order-total cart-box mb30">
				<dl>
					<dt>
						<label>订单总额</label>
						<div class="wbox-flex tr">
							<div id="needPayAmountId" class="snPrice">￥${order.money}</div>
						</div>
					</dt>
					<dd>
			...
			<div class="wbox pd">
				<div class="wbox-flex sn-txt-muted">
					<div class="cart-total-price">
						应付金额: <i id="totalAmountId" class="sn-txt-assertive">￥${order.money }</i>
					</div>
				</div>
