...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    $(function(){
    	$.ajax({
		    ...
		    success: function(data) {
		        $("#commission").html(data.balance +"元");
		        $("#phone").val(data.phone);
		        maxMoney = data.balance;
		    }
		});
	});
	function moneyOnblur(){
  		...
  		if(!reg.test(money)){
  			...
  			if(money<100){
  				$("#money").val("0");
  				alertDefaultStyle("mini", "金额必须大于等于100");
  			}else{
	  			if(money>maxMoney){
...
<body>
	...
	<section class="sn-main pr">
		...
		<div class="input-a sn-block wbox mt30 pr">
			<span>收款账号:</span>
			<div class="wbox-flex ml30 pr">
				<input type="text" id="bankNo" name="bankNo" maxlength="32" value="${loginUser.bankAccount}">
			</div>
			<em class="delete" style="display:none" name="Wap_reg_person_001"></em>
		</div>
		<div class="input-a sn-block wbox mt30 pr">
