	...
	function rechargeCardSave() {
		...
		if (no == "") {
			...
			if (no.length < 10) {
				...
				$.ajax({
					url : "../user/userUseRechargeCard?no=" + no,
					type : "GET",
					dataType : "json",
					async : false,
...
<body>
	...
	<section class="sn-main pr">
		...
		<a href="javascript:rechargeCardSave()" name="Wap_reg_person_005"
			class="first-step sn-btn sn-btn-big sn-btn-block m30 sn-btn-positive">充值</a>
	</section>
