...
<section class="shopping-car" style="display: block;">
    <div>
        ...
        <div class="shopping-car-fun">
            <a data-name="prodDetail_none_main_buy" id="buyNow" href="<%=basePath %>user/ordersSave?pid=${product.id}&num=1" style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">快速下单</a>
        </div>
    </div>
</section>
                ...
                <div class="desc-spec sn-tab-box wbox-flex" style="height: auto;">
                    ...
                    <div class="desc-spec-sale desc-spec-item" style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">
                        <a href="javascript:void(0);">
                            <dl>
                                <dt data-name="prodDetail_none_main_forkSHFW" >
                                    <span class="cm-direct-t" ></span>
                                </dt>
                            <dd><p id="procontent">
                            ${product.content}
                            </p></dd></dl>
