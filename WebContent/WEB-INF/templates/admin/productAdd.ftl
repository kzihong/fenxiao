	                ...
	                <tbody>
						...
						<tr>
	                        <td>
	                            ...
	                            <input type="text" name="product.odds" id="odds" data-rule="required;number" size="10" placeholder="请输入产品赔率">
	                        </td>
	                    </tr>
                        <tr>
                            <td>
                                <label for="odds" class="control-label x90">分销用户赔率：</label>
                                <input type="text" name="product.oddsFx" id="oddsFx" data-rule="required;number" size="10" placeholder="请输入产品赔率">
                            </td>
                        </tr>
	                    <tr>
	                        <td>
