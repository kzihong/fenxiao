    ...
    <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
		...
		<tbody>
            ...
            <tr>
                ...
                <td>
                	<a href="productEdit?id=${product.id?c}" class="btn btn-green" data-toggle="dialog" data-width="1000" data-height="600" data-id="productEdit" data-mask="true">编辑</a>
                    <a href="productDelete?id=${product.id?c}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该产品吗？删除之后，该产品的所有卡密将被清空！！！">删</a>
                </td>
            </tr>
		</#list>
		</tbody>
