        ...
        <div class="pageFormContent" data-layout-h="0">
	            ...
	            <table class="table table-condensed table-hover" width="100%">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        <td>
	                            <label for="odds" class="control-label x90">普通用户赔率：</label>
	                            <input type="text" name="product.odds" id="odds" data-rule="required;number" size="10" placeholder="请输入普通用户赔率" value="${product.odds}">
	                        </td>
	                    </tr>
                        <tr>
                            <td>
                                <label for="odds" class="control-label x90">分销用户赔率：</label>
                                <input type="text" name="product.oddsFx" id="odds" data-rule="required;number" size="10" placeholder="请输入分销用户赔率" value="${product.oddsFx}">
                            </td>
                        </tr>
	                    <tr>
	                        <td>
