        ...
        <div class="pageFormContent" data-layout-h="0">
	            ...
	            <table class="table table-condensed table-hover" width="100%">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        <td>
	                            <label for="j_custom_content" class="control-label x90">优先级：</label>
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <select name="article.status" id="status" data-rule="required" data-width="auto">
	                                <option value="0" <#if article.status==0>selected="selected"</#if>>未置顶</option>
	                                <option value="1" <#if article.status==1>selected="selected"</#if>>已置顶</option>
                            	</select>
	                        </td>
	                    </tr>
	                </tbody>
