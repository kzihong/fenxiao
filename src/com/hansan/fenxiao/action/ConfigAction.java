	...
	public void update() {
		...
		try {
			if (loginAdmin.getJuri() != 1) {
				...
				findConfig.setFirstLevel(this.config.getFirstLevel());
...
//				findConfig.setThirdLevel(Double.valueOf(this.config.getThirdLevel().doubleValue() / 100.0D));
				...
				findConfig.setAcceptExcelEmail(this.config.getAcceptExcelEmail());
				findConfig.setEmailStmpCode(this.config.getEmailStmpCode());
				findConfig.setCurrentYeas(this.config.getCurrentYeas());
				findConfig.setBannerUrl(this.config.getBannerUrl());
				findConfig.setNewsUrl(this.config.getNewsUrl());
				findConfig.setNextTerm(this.config.getNextTerm());
				findConfig.setMsgAPIPassword(this.config.getMsgAPIPassword());
				findConfig.setMsgAPITemplate(this.config.getMsgAPITemplate());
				findConfig.setMsgAPIUsername(this.config.getMsgAPIUsername());
				findConfig.setEztzze(this.config.getEztzze());
				findConfig.setSzezzs(this.config.getSzezzs());
